...
function openWAModal()  { if (!waModal) return; waModal.classList.add('open'); document.body.style.overflow='hidden'; }
function closeWAModal() { if (!waModal) return; waModal.classList.remove('open'); document.body.style.overflow=''; }
